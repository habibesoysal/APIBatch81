...
public class Get01 {
    ...
    3) Otomasyon testlerimizi yaparken aşağıdaki adımları izliyoruz:
        ...
        b) Test Case yazıyoruz
            i) Test Case yazımında Gherkin Language kullanacağız. Bizler yazılım diline hakim olsak da karşımızdaki
            kişiler hakim olmayabilir. Gherkin ile yazılan testleri anlamakta zoruluk çekmeyeceklerdir.
